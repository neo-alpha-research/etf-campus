  ...
  return (
    <html lang="ko">
      ...
      <body className="flex min-h-screen flex-col antialiased">
        ...
        <div id="site-fixed-header" className="fixed top-0 w-full shrink-0 z-[100] bg-white border-b border-line shadow-xs">
          <MarketTicker />
          {siteConfig.isBeta ? (
        ...
        <main className="flex flex-1 flex-col pt-[132px] sm:pt-[121px]" id="main-content">{children}</main>
        <SiteFooter />
        <AppBottomTab />
        <AppPushInitializer />
