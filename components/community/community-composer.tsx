...
const WRITING_TEMPLATES: Record<string, WritingTemplate> = {
  ...
  "stock-cost-analysis": {
    ...
    hint: "글 본문에 종목명(예: KODEX 200)이나 6자리 종목코드(예: 069500)를 입력하시면 다른 회원들과 명확하게 소통할 수 있습니다.",
    body: "## 분석 대상 ETF\n예: KODEX 200 (069500) vs TIGER 미국S&P500 (379800)\n\n## 확인한 데이터 (실부담비용 / 괴리율 / 분배금)\n\n## 분석 및 비교 포인트\n\n## 최종 판단 기준 및 유의점\n",
  },
  "pension-etf-qna": {
  ...
  feedback: {
    titlePlaceholder: "개선 의견이나 오류가 발생한 화면/기능을 간략히 적어 주세요",
    hint: "오류가 발생한 웹페이지 주소(URL)나 관련 ETF 종목명(또는 6자리 종목코드)을 함께 적어주시면 더욱 신속히 조치됩니다.",
    body: "## 1. 제보 유형\n- [ ] 데이터 수치 이상\n- [ ] 화면 표시 / UI 오류\n- [ ] 새로운 기능 제안\n- [ ] 기타 개선 의견\n\n## 2. 발생 위치 (화면명 또는 URL)\n예: ETF 비교 (/compare) 페이지 / 마켓 브리핑 (/briefing)\n\n## 3. 관련 ETF 종목 (선택 사항)\n예: KODEX 200 (069500) / TIGER 미국S&P500 (379800)\n\n## 4. 상세 내용 및 개선 제안\n- 현재 화면 현상:\n- 기대하는 동작 또는 제안 내용:\n",
  },
};
