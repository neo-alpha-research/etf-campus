...
const campusFacilities = [
  ...
  },
  {
    ...
    professorQuote:
      "이름이 비슷하다고 같은 ETF가 아닙니다. 비교할 종목들을 나란히 올려두고 총보수, 순자산 규모, 거래대금, 구간별 수익률을 한눈에 대조해 보세요.",
    features: [
      "관심 ETF 핵심 스펙 1:1 나란히 맞비교",
