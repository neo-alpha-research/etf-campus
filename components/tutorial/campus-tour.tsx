...
const campusFacilities = [
  {
    ...
    professorQuote:
      "성공 투자의 첫걸음은 나 자신의 투자 DNA를 아는 것입니다. 1분 동물 성향 검사를 통해 나만의 투자 본능과 맞춤형 포트폴리오를 처방받아 보세요.",
    features: [
  ...
  },
  {
    ...
    professorQuote:
      "시황에 일희일비하지 않고 시장의 맥락을 읽는 훈련이 매일의 출석체크입니다. 장단기 금리차와 ETF 자금 흐름을 매일 아침 브리핑받아 보세요.",
    features: [
  ...
  },
  {
    ...
    professorQuote:
      "국내 상장된 900여 개 ETF를 일반계좌, 연금저축, IRP, 혼합채권 등 내 계좌 목적에 맞게 쏙쏙 골라낼 수 있는 지식의 보고입니다.",
    features: [
  ...
  },
  {
    ...
    professorQuote:
      "이름이 비슷하다고 같은 상품이 아닙니다. 두 종목을 나란히 두고 숨겨진 비용, 과거 수익률, 분배금을 꼼꼼하게 대조해 보세요.",
    features: [
  ...
  },
  {
    ...
    professorQuote:
      "존 보글, 벤저민 그레이엄 등 검증된 대가들의 투자 원칙과 캠퍼스가 엄선한 연금 바이블을 읽고 깊이 있는 지혜를 나누어 보세요.",
    features: [
  ...
  },
  {
    ...
    professorQuote:
      "투자 여정은 긴 마라톤과 같습니다. 외롭게 혼자 고민하지 마시고, 동문들과 함께 스터디하며 실전 인사이트를 나누어 보세요.",
    features: [
