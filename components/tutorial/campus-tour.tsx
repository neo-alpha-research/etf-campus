...
const campusFacilities = [
  ...
  },
  {
    ...
    description:
      "이름이 비슷하다고 같은 ETF가 아닙니다. 금융 테마 온톨로지 엔진이 AI전력·2차전지·반도체 등 진짜 동종 ETF 4종을 즉시 추천하며, [최저 보수 🥇]·[거래대금 1위 💧] 등 핵심 강점을 3초 만에 짚어드립니다.",
    features: [
      "금융 온톨로지 기반 가장 가까운 동종 ETF 4종 즉시 자동 추천",
      "최저 보수·최대 거래대금·순자산·1년 성과 1위 '스마트 장점 칩' 안내",
      "환헤지·커버드콜·TR(배당재투자) 수익구조 차이점 및 주의 배지 대조",
    ],
    actionType: "link",
