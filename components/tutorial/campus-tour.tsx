...
const campusFacilities = [
  ...
  },
  {
    ...
    description:
      "국내 1,160여 개 ETF를 내 투자 목적에 맞춰 스마트하게 찾는 곳입니다. 10대 인기 테마 조건 검색부터 [일반·연금·혼합채권·TDF·레버리지·신규상장] 6대 맞춤 퀵 탐색과 1초 비교 바구니까지 한 번에 경험해 보세요.",
    features: [
      "조건 검색: DC·IRP 연금 편입, 10대 인기 테마, 총보수·순자산 다차원 필터",
      "6대 퀵 탐색: 일반·연금·혼합채권·TDF(내나이맞춤)·레버리지·신규상장 프리셋",
      "1초 비교 바구니: 탐색 리스트에서 [+] 버튼으로 즉시 담아 1:1 심층 대조",
    ],
    actionType: "link",
