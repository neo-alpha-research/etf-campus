...
const campusFacilities = [
  ...
  },
  {
    ...
    description:
      "이름이 비슷하다고 같은 ETF가 아닙니다. 관심 종목을 하나만 골라도 가장 가까운 동종 ETF 4종을 스마트 엔진이 즉시 추천해 드립니다. 총보수(운용보수), 거래대금, 11개 구간 수익률은 물론 환헤지·분배금 구조 차이까지 한눈에 대조해 보세요.",
    features: [
      "1종목 선택 시 가장 가까운 동종 ETF 4종 즉시 자동 추천",
      "총보수(운용보수), 순자산(AUM), 11개 구간별 수익률 대조",
