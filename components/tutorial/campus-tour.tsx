...
const campusFacilities = [
  {
    ...
    description:
      "투자의 출발점은 나만의 투자 성향을 명확히 아는 것입니다. 10가지 동물 성향 진단을 통해 나의 투자 스타일을 점검하고, 맞춤형 자산배분 방향과 필독 도서를 확인해 보세요.",
    features: [
      "10가지 동물 유형 기반 투자 성향 진단",
      "성향별 자산배분 방향 및 학습 가이드",
      "투자 성향 맞춤 필독 도서 및 독서 가이드",
    ],
    actionType: "modal",
  ...
  },
  {
    ...
    subtitle: "국내 1,170+개 ETF 조건별 정밀 검색 및 계좌별 6대 퀵 탐색",
    description:
      "국내 상장된 1,170여 개 ETF 중 내 투자 목적에 꼭 맞는 종목을 스마트하게 찾는 곳입니다. 10대 인기 테마 조건 검색부터 [일반·연금·혼합채권·TDF·레버리지·신규상장] 6대 맞춤 퀵 탐색까지 한 번에 경험해 보세요.",
    features: [
      "조건 검색: DC·IRP 연금 편입, 10대 인기 테마, 총보수·순자산 다차원 필터",
      "6대 퀵 탐색: 일반·연금·혼합채권·TDF(내나이맞춤)·레버리지·신규상장 프리셋",
      "성과 지표: 1일~3년 기간별 수익률 랭킹 차트 & 주요 지표 정렬",
    ],
    actionType: "link",
  ...
  },
  {
    id: "lab",
    badge: "금융공학 랩실",
    tag: "⚡ 1종목 선택 시 동종 4종 자동 매칭",
    icon: "🔬",
    title: "전공 비교 분석실 (ETF 비교)",
    subtitle: "관심 종목 1개만 골라도 가장 가까운 동종 4종 자동 매칭 & 정밀 대조",
    description:
      "이름이 비슷하다고 같은 ETF가 아닙니다. 표기가 달라도 AI전력·2차전지·반도체 등 실제 투자 테마를 정밀 분석해 진짜 동종 ETF 4종을 즉시 매칭하며, [최저 보수 🥇]·[거래대금 1위 💧] 등 핵심 강점을 3초 만에 짚어드립니다.",
    features: [
      "연관 산업·키워드 정밀 분석으로 가장 가까운 동종 ETF 4종 즉시 자동 매칭",
  ...
  },
  {
    ...
    description:
      "연금 투자는 수십 년을 이어가는 긴 마라톤입니다. 혼자 고민하지 마시고, 동문들과 함께 나만의 자산배분 포트폴리오와 실전 ETF 종목 분석을 자유롭게 나누어 보세요.",
    features: [
      "ISA·연금 포트폴리오 비중 및 리밸런싱 전략 공유",
      "종목명·코드 기반의 실부담비용 및 보수·수익구조 분석",
