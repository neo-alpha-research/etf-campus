...
const campusFacilities = [
  ...
  },
  {
    ...
    subtitle: "국내 1,160+개 ETF 조건별·테마별 정밀 탐색",
    description:
      "국내 상장된 1,160여 개 ETF 중 내 투자 목적에 꼭 맞는 종목을 찾는 곳입니다. TOP 10 인기 테마 퀵 필터와 연금 편입 여부, 총보수, 순자산 규모, 환헤지 여부를 꼼꼼하게 필터링해 보세요.",
    features: [
      "DC·IRP 연금 편입 여부 및 10대 인기 테마 퀵 필터",
      "1일~3년 기간별 실시간 랭킹 차트 & 주요 지표 정렬",
      "총보수, 순자산, 환헤지, 운용사, 전략별 다차원 정밀 필터",
    ],
    actionType: "link",
  ...
  },
  {
    id: "lab",
    badge: "금융공학 랩실",
    tag: "🔬 1종목 선택 시 4종 자동 추천",
    icon: "🔬",
    title: "전공 비교 분석실 (ETF 비교)",
    subtitle: "1종목만 골라도 가장 가까운 동종 4종 자동 추천 & 정밀 대조",
    description:
      "이름이 비슷하다고 같은 ETF가 아닙니다. 관심 종목을 하나만 골라도 가장 가까운 동종 ETF 4종을 스마트 엔진이 즉시 추천해 드립니다. 총보수, 거래대금, 11개 구간 수익률은 물론 환헤지·수익구조 차이까지 한눈에 대조해 보세요.",
    features: [
      "1종목 선택 시 가장 가까운 동종 ETF 4종 즉시 자동 추천",
      "총보수, 순자산(AUM), 일일 거래대금, 11개 구간별 수익률 대조",
      "환헤지·커버드콜·수익구조 차이점 및 추천 사유 배지 안내",
    ],
    actionType: "link",
