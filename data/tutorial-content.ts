...
export const tutorialSteps: TutorialStep[] = [
  ...
  {
    step: 3,
    title: "[특례 구조] 3년 만기 ISA 자금의 최대 198만 원 연금 이전 세액공제",
    benefitBadge: "ISA 3년 만기 최대 198만 원 세액공제 특례",
    intro: "ISA 3년 만기 자금을 연금 계좌로 넘겨 세액공제 한도를 추가 확보하는 실전 계산법입니다.",
    questions: [
      {
        id: "3-1",
        ...
        incorrectFeedback: "만기 자금 3,000만 원을 연금으로 넘기면 10%인 300만 원이 추가 공제되어 당해 연도 세액공제 대상 한도가 최대 1,200만 원까지 확장됩니다. 실제 세액공제액은 적용 세율에 따라 최대 198만 원(16.5% 기준)이며, 실제 환급액은 납부한 세액 범위 안에서 결정됩니다."
      },
      {
        id: "3-2",
