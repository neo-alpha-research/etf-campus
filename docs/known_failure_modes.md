...
- **방어 대책**:
  ...
  3. 채널별 차등화 해시태그 전략: 스레드는 메타 알고리즘 감점 방지를 위한 단 1개의 니치 태그(`#ETFCampus`)를 강제하고, 인스타그램은 검색·탐색 탭(Explore Tab) SEO 노출을 위해 5대 큐레이션 해시태그(`#ETFCampus #ETF투자 #ETF브리핑 #마켓브리핑 #재테크`)를 표준 유지 (10개 이상 무분별한 스팸 태그는 차단).
