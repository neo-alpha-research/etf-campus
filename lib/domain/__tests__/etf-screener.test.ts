...
import { DEFAULT_SCREENER_FILTERS, filterEtfs, parseScreenerQuery, serializeScreenerQuery, type ScreenerFilters } from "../etf-screener";
...
function etf(overrides: Partial<Etf>): Etf {
  return {
    ...
    fee: null, issuer: { issuerId: "A", issuerName: "A", brand: "A", issuerStatus: "verified_official", issuerSourceUrl: null, issuerVerifiedAt: null }, classification: null, listingDateStatus: null, firstTradedDate: null, firstTradedDateSource: null, listingDateVerifiedAt: null, listingDateEvidenceId: null,
