...
export const GENERAL_RETURN_PERIODS = ["ytd", "1d", "1w", "2w", "1m", "2m", "3m", "6m", "12m", "24m", "36m"] as const satisfies readonly ReturnPeriod[];
export const NEW_RETURN_PERIODS = ["itd", "1d", "1w", "2w", "1m", "2m"] as const satisfies readonly ReturnPeriod[];
