...
values
  ...
  ('etf-questions', 'ETF 정보·질문', 'ETF 구조와 정보 해석 기준을 함께 확인하는 공간입니다.', 20, true),
  ('challenge-30', '30일 챌린지', '투자 판단 기준을 학습하는 30일 실천 공간입니다.', 30, true),
  ('feedback', '오류·기능 제안', '데이터 오류와 기능 개선 의견을 남기는 공간입니다.', 40, true)
