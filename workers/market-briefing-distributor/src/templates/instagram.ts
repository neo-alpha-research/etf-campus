...
export function generateInstagramCarousel(payload: MarketBriefingPayload, baseUrl: string): InstagramSlide[] {
  ...
  const slide6Svg = `
    <svg width="1080" height="1350" viewBox="0 0 1080 1350" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- 2. Grand Hero CTA Card (High-Converting Single Action) -->
      <g transform="translate(70, 720)" filter="url(#softShadow)">
        <rect width="940" height="510" rx="30" fill="url(#brandGrad)"/>
        
        <g transform="translate(0, 0)">
          <!-- Top Mini Tag -->
          <rect x="320" y="40" width="300" height="38" rx="19" fill="#064E3B" fill-opacity="0.6" stroke="#6EE7B7" stroke-width="1.2"/>
          <text x="470" y="65" fill="#A7F3D0" font-size="16" font-weight="900" text-anchor="middle">💡 100% 무료 ETF 진단 &amp; 마켓 브리핑</text>
          ...
          <g transform="translate(0, 155)">
            <text x="470" y="40" fill="#ECFDF5" font-size="21" font-weight="700" text-anchor="middle">
              ✅ <tspan font-weight="900" fill="#FFFFFF">1,022개 전종목</tspan> 총보수 &amp; 실시간 괴리율 1초 완벽 비교
            </text>
            <text x="470" y="78" fill="#ECFDF5" font-size="21" font-weight="700" text-anchor="middle">
              ✅ 주도 테마별 등락 동향부터 스마트머니 자금 유입까지
            </text>
            <text x="470" y="116" fill="#ECFDF5" font-size="21" font-weight="700" text-anchor="middle">
          ...
          <g transform="translate(100, 325)">
            <rect width="740" height="92" rx="26" fill="#F59E0B" filter="url(#cardShadow)"/>
          ...
          <!-- Sub Guarantee -->
          <text x="470" y="462" fill="#A7F3D0" font-size="16" font-weight="700" text-anchor="middle">
