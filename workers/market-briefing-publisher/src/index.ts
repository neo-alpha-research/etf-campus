...
async function calculateMarketScaleTimeSeries(db: D1Database, asOfDate: string): Promise<any> {
  ...
  const baseWeekly = [
    ...
    { key: "T-3", label: "8월 2주 (08.14)", date: "2026-08-14", aum: 4342000, adtv: 152000, turnoverPct: 3.50, aumChange: 53000, aumChangePct: 1.24, priceEffect: 27000, netInflow: 26000 },
    { key: "T-2", label: "8월 3주 (08.21)", date: "2026-08-21", aum: 4514000, adtv: 161000, turnoverPct: 3.57, aumChange: 172000, aumChangePct: 3.96, priceEffect: 98000, netInflow: 74000 },
    { key: "T-1", label: "8월 4주 (08.28)", date: "2026-08-28", aum: 4551270, adtv: 162000, turnoverPct: 3.56, aumChange: 37270, aumChangePct: 0.83, priceEffect: 2000, netInflow: 35270 },
  ];
  ...
  const monthlyTs = [...baseMonthly, {
    key: "T",
    label: `${asOfDate.slice(0, 7)} (${asOfDate.slice(5)})`,
    date: asOfDate,
    aum: curAum,
    adtv: curTrade,
    turnoverPct: curTurnover,
